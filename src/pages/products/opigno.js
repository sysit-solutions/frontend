      ...
      <Template style={{}}>
        <div style={styles.above}>
          <p style={styles.above.message}>
            ...
            Opigno, you can create engaging lectures that your learners will
            love.
          </p>
          <div style={styles.above.picture} />
        </div>
        <h1 style={styles.what}>What is Opigno?</h1>
        <div style={styles.what.explanation}>
          Opigno has been the world's most popular open-source learning
          management system since 2005 because it is easy to use, affordable and
          adaptable to any educational environment. Today, Opigno has grown into
          one of the most popular LMSs in the world with over 18 million users
          and 15 thousand schools using it every day.
        </div>
        <h1 style={styles.how}>How to make interactive Opigno courses?</h1>
        <div style={styles.how.explanation}>
          <p>
            ...
            our Opigno installations. We believe that H5P can be a valuable tool
        ...
        <div style={styles.help.content}>
          <div style={styles.help.inner}>
            <p>
              If Opigno sounds like something you might be interested in, but
              ...
              needs. Our team of Opigno experts can also walk you through the
...
export default withTheme(Opigno)
